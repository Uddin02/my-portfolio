...
import { FaChrome, FaCss3Alt, FaEnvira, FaFigma, FaGitAlt, FaGithub, FaHtml5, FaJsSquare, FaNode, FaReact, FaSun } from "react-icons/fa";
...
const Skills = () => {
    ...
    const expertise = [
        ...
        },
        {
          ...
          name: "ES6",
          icon: (
            <span className="text-[8px] pt-2 pl-2 pb-0.5 pr-0.5 rounded bg-yellow-400">
              <>E</>
              <>S</>
            </span>
          ),
